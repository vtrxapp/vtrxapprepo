...
router.get('/recipes/categorized',       nutrition.getCategorizedRecipes);   // GET /nutrition/recipes/categorized — all 11 categories, fetches <=15 each (frontend dedupes vs "Recommended" then shows <=10)
